...
#ifndef OpenSMOKE_PreProcessorLiquidKineticsPolicy_CHEMKIN_H
#define	OpenSMOKE_PreProcessorLiquidKineticsPolicy_CHEMKIN_H
...
namespace OpenSMOKE
{
	...
	*/
	...
	class PreProcessorLiquidKineticsPolicy_CHEMKIN
	{
	public:

		typedef std::vector<ReactionPolicy_Liquid_CHEMKIN> vector_reactions;

		/**
		* Default constructor
		*/
		PreProcessorLiquidKineticsPolicy_CHEMKIN();

		/**
		* Copy constructor
		*/
		PreProcessorLiquidKineticsPolicy_CHEMKIN(const PreProcessorLiquidKineticsPolicy_CHEMKIN& orig);

		/**
		* Default destructor
		*/
		virtual ~PreProcessorLiquidKineticsPolicy_CHEMKIN();
	
		/**
		*@brief This function returns the vector containg the list of reactions
		*@return the vector containing the list of reactions
		*/
		vector_reactions& reactions(const unsigned int j) { return reactions_[j]; }

		/**
		*@brief This function returns the vector containg the list of reactions
		*@return the vector containing the list of reactions
		*/
		const vector_reactions& reactions(const unsigned int j) const { return reactions_[j]; }
		...
		*/
		const std::vector<std::string>& names_liquid_species() const { return names_liquid_species_; }

		/**
		*@brief This function returns the vector containg the list of all the additional species 
		*@return the vector containing the list of site species
		*/
		const std::vector<std::string>& names_additional_species() const { return names_liquid_species_; }
	...
	protected:
		...
		std::vector<std::vector<std::string> >	liquid_species_;			//!< structured map of liquid species names
		std::vector<std::vector<unsigned int> >	liquid_species_indices_;	//!< structured map of liquid species indices
		std::vector<std::string>				names_liquid_species_;		//!< svector of liquid species indices
...
#include "PreProcessorLiquidKineticsPolicy_CHEMKIN.hpp"

#endif	/* OpenSMOKE_PreProcessorLiquidKineticsPolicy_CHEMKIN_H */
