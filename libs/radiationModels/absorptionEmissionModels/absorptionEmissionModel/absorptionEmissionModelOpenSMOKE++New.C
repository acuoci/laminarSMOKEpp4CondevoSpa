...
Foam::autoPtr<Foam::radiationModels::absorptionEmissionModelOpenSMOKEpp>
Foam::radiationModels::absorptionEmissionModelOpenSMOKEpp::New
(
...
)
{
    ...
    return autoPtr<absorptionEmissionModelOpenSMOKEpp>(cstrIter()(dict, mesh));
}
