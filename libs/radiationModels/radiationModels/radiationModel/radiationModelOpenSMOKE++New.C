...
Foam::autoPtr<Foam::radiationModelOpenSMOKEpp> Foam::radiationModelOpenSMOKEpp::New
(
...
)
{
    ...
    {
        Info<< "Radiation model not active: radiationProperties not found" << endl;
    }

    Info<< "Selecting radiationModelOpenSMOKEpp " << modelType << endl;
    ...
    return autoPtr<radiationModelOpenSMOKEpp>(cstrIter()(T));
}
...
)
{
    ...
    return autoPtr<radiationModelOpenSMOKEpp>(cstrIter()(dict, T));
}
