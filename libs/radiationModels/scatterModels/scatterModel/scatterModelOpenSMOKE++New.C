...
Foam::autoPtr<Foam::radiationModels::scatterModelOpenSMOKEpp>
Foam::radiationModels::scatterModelOpenSMOKEpp::New
(
...
)
{
    ...
    return autoPtr<scatterModelOpenSMOKEpp>(cstrIter()(dict, mesh));
}
