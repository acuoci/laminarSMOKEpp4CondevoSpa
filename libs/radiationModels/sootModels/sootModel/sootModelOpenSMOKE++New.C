...
Foam::autoPtr<Foam::radiationModels::sootModelOpenSMOKEpp>
Foam::radiationModels::sootModelOpenSMOKEpp::New
(
...
)
{
    ...
    return autoPtr<sootModelOpenSMOKEpp>(cstrIter()(dict, mesh, className));
}
